...
namespace SURO2
{
    public partial class EditarOficioInterno : System.Web.UI.Page
    {
        ...
        private void CargarDatosOficio(int id)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("SP_MuestraOficioInternoEditar", con))
            {
                ...
                using (SqlConnection con1 = funciones.ConBD())
                {
                    ...
                    if (ArchivoOficio.HasFile)
                    {
                       ...
                       // string folioSanitizado = System.Text.RegularExpressions.Regex.Replace(Folio.Text.Trim(), @"[^a-zA-Z0-9\._-]", "_");
                        ...
                        string nombreArchivo = noOficioSanitizado + "_" + fechaFormateada + "_" + idFolio + extension;
                    ...
                    using (SqlCommand cmdRuta = new SqlCommand("SP_ModificaOficioInternos", con1, transaccion))
                    {
