<%@ Page Title="" Async = "true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarOficio.aspx.cs" Inherits="SURO2.EditarOficio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
                  ...
                  <div class="col-12 ">
                      <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                          <div class="card-body p-6 p-md-5">
                              <h3 class="mb-6 pb-2 pb-md-0 mb-md-6">Modificación de Oficios Externos</h3>
                              <div class="row">                              
                              ...
                              <div class="row">
                                  <div class="col-md-6 mb-4 d-flex align-items-center">
                                      <div class="form-group">
                                          ...
                                          <asp:DropDownList ID="Municipios" Placholder="Seleccione" runat="server" DataSourceID="dsMunicipio" class="form-control" DataTextField="Municipio" DataValueField="ID"></asp:DropDownList>
    ...
    function validarFormulario() {
        ...
        if (municipio.value === '0') { // El ID 0 corresponde a la opción "--Seleccione--"
